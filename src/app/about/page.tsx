      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <ContentSection title="✨ サイトのええとこ">
            ...
            <p>
              条文や解説の部分をクリックするだけで、原文と大阪弁訳を簡単に切り替えられるんやで。
              スペースキーでも切り替えできるさかい、キーボード操作もらくらくやで。
            </p>

            <h3 className="text-lg font-bold text-gray-700">🔊 音声読み上げ</h3>
            <p>
              各条文には音声読み上げ機能が付いてるんや。原文は男性の声、大阪弁訳は女性の声で、
              聞いて学ぶこともできるんやで。
            </p>

            <h3 className="text-lg font-bold text-gray-700">📱 モバイル対応</h3>
            <p>
              スマートフォンやタブレットでも快適に読めるよう、レスポンシブデザインで作ってあるんやで。
            </p>
          ...
          <ContentSection title="📚 何が入ってるん？">
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>日本国憲法</strong> - 103条文
              </li>
              <li>
                <strong>AI推進法</strong> - 28条文（附則含む）
              </li>
              <li>
                <strong>十七条の憲法</strong> - 17条文
              </li>
              <li>
                <strong>マグナ・カルタ</strong> - 46条文
              </li>
              <li>
                <strong>南極条約</strong> - 14条文
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li>
                <strong>日本の法律：</strong> 民法、商法、刑法、民事訴訟法、刑事訴訟法ほか
              </li>
              <li>
                <strong>日本の歴史法：</strong> 御成敗式目、武家諸法度、明治憲法ほか
              </li>
              <li>
                <strong>外国の憲法：</strong> ドイツ基本法、アメリカ合衆国憲法、中華人民共和国憲法
              </li>
              <li>
                <strong>外国の歴史法：</strong> ハンムラビ法典、ナポレオン法典
              </li>
              <li>
                <strong>国際条約：</strong> 国連憲章、核兵器不拡散条約、宇宙条約ほか
              </li>
            </ul>
