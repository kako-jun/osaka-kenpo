...
const ViewModeToggle = () => {
  ...
  // 条文ページ（/law/category/law/article）のみで表示
  const pathParts = pathname.split('/').filter(Boolean);
  const isArticlePage = pathParts[0] === 'law' && pathParts.length === 4;
  ...
  return (
    <div className="absolute top-1/2 right-4 -translate-y-1/2">
      ...
      >
        ...
        {/* Text Labels */}
        <div
          className="relative z-10 w-1/2 text-center text-xs font-bold"
          onClick={() => setViewMode('osaka')}
        >
