  ...
  if (isMobile) {
    return (
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={onShowPopup}
          className="text-blue-600 font-medium hover:text-blue-800 px-2 py-1 text-sm"
        >
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <div className="relative">
        <button
          onClick={onShowPopup}
          className="text-blue-600 font-medium hover:text-blue-800 hover:bg-blue-50 px-3 py-2 rounded-md transition-colors cursor-pointer"
        >
          {formatArticleNumber(currentArticle)} ({currentIndex + 1} / {totalArticles})
        </button>
      </div>
